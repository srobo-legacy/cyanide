 ...
 * @parm timeoutSeconds: The maximum duration to allow the process to run. 0 (the default) means no limit.
 ...
 */
function proc_exec($s_command, $base = null, $input = null, $env = array(), $catchResult = false, $timeoutSeconds = 0)
{
