	...
	<div id="page">
		...
		<div id="team-status-page" class="page">
			...
			<ul class="info">
				...
				<li><img src="web/images/icons/cross.png" alt="Cross" /> The change has been rejected. Please see the "Team Status Feedback" thread on the <a href="<?=$root_url ?>/forum/">forums</a> to see why.</li>
			</ul>
			<table>
